...
class MissileNode: SKSpriteNode, PhysicsNodeProtocol {
    ...
    required init(systemName: String = K.missileAssetName, anchorPoint: CGPoint = CGPoint(x: 0, y: 0), size: CGSize, position: CGPoint, zPosition: CGFloat = 10.0, zRotation: CGFloat, name: String = "missile", category: UInt32 = K.largeAssteroidCategory) {
        var asset: UIImage {
    ...
    required init(named: String, anchorPoint: CGPoint = CGPoint(x: 0, y: 0), size: CGSize, position: CGPoint, zPosition: CGFloat = 10.0, zRotation: CGFloat, name: String = "missile", category: UInt32 = K.largeAssteroidCategory) {
        var asset: UIImage {
